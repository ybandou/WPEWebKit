...
#define WL_DISPMANX_WRAP_BUFFER	1
...
static inline struct wl_buffer *
wl_dispmanx_wrap_buffer(struct wl_dispmanx *wl_dispmanx, uint32_t handle, int32_t width, int32_t height, uint32_t stride, uint32_t buffer_height, uint32_t format)
{
	struct wl_proxy *id;

	id = wl_proxy_marshal_constructor((struct wl_proxy *) wl_dispmanx,
			 WL_DISPMANX_WRAP_BUFFER, &wl_buffer_interface, NULL, handle, width, height, stride, buffer_height, format);
