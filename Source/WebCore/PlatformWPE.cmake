...
list(FIND WebCore_LIBRARIES EGL EGL_OPTION_INDEX)
    if (NOT $EGL_OPTION_INDEX EQUAL -1)
        list(INSERT WebCore_LIBRARIES  $EGL_OPTION_INDEX ${WAYLAND_EGL_LIBRARIES})
        list(INSERT WebCore_LIBRARIES  $EGL_OPTION_INDEX ${WAYLAND_LIBRARIES})
        list(REMOVE_ITEM WebCore_LIBRARIES  wayland-server)
    endif ()
endif ()
