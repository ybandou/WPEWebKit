...
public:
    ...
    virtual RefPtr<RTCRtpReceiver> createReceiver(const String& transceiverMid, const String& trackKind, const String& trackId) override;
...
private:
    ...
    Vector<RefPtr<RTCDataChannel>> m_remoteDataChannels;
